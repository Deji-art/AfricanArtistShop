...
(function(){
  ...
  function setupLayout(){
    ...
    if(!document.getElementById('artistPaths')){
      ...
      if(hero && !document.getElementById('adSlotHero')){ const ad=document.createElement('div'); ad.id='adSlotHero'; ad.className='ad-slot'; ad.innerHTML='<span>ADVERTISEMENT</span><strong>Space reserved for a future AfricanArtistShop partner</strong>'; hero.parentNode.insertBefore(ad,hero.nextSibling); }
      const sig=document.getElementById('signature');
      if(sig && !document.getElementById('adSlotSignature')){ const ad=document.createElement('div'); ad.id='adSlotSignature'; ad.className='ad-slot'; ad.innerHTML='<span>ADVERTISEMENT</span><strong>Promote an art exhibition, creative service or approved partner here.</strong>'; sig.parentNode.insertBefore(ad,sig); }
      const footerEl=document.querySelector('footer');
      if(footerEl && !document.getElementById('adSlotFooter')){ const ad=document.createElement('div'); ad.id='adSlotFooter'; ad.className='ad-slot ad-slot-footer'; ad.innerHTML='<span>ADVERTISEMENT</span>'; footerEl.parentNode.insertBefore(ad,footerEl); }
