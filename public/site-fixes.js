...
(function(){
  ...
  function setupLayout(){
    ...
    directoryCards.forEach((card,i)=>{
      ...
      img.className='directory-portrait'; img.src=p[0]; img.alt=p[1]+' portrait'; img.loading='lazy';
