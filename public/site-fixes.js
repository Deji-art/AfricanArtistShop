...
(function(){
  ...
  function setupLayout(){
    ...
    if(!document.getElementById('artistPaths')){
      ...
      if(hero && !document.getElementById('adSlotHero')){ const ad=document.createElement('div'); ad.id='adSlotHero'; ad.className='ad-slot'; ad.innerHTML='<span>ADVERTISEMENT · MUST BUY</span><div class="ad-content"><img src="https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=700&q=80" alt="Acrylic Paint Set"><div><strong>Acrylic Paint Set</strong><p>Build your studio with a versatile acrylic paint set.</p><button class="btn primary" type="button" onclick="document.getElementById(\'supplies\').scrollIntoView({behavior:\'smooth\'});setTimeout(()=>{const q=document.getElementById(\'supplyQ\');if(q){q.value=\'Acrylic Paint Set\';loadSupplies()}},150)">Shop now</button></div></div>'; hero.parentNode.insertBefore(ad,hero.nextSibling); }
